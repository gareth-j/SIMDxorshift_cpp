...
protected:
    ...
    __m256i simd_xorshift128plus_rand(simd_avx512_xorshift128plus_key& key)
    {
...
public:
    ...
    __m256i get_rand(simd_avx512_xorshift128plus_key& key)
    {
    	return simd_xorshift128plus_rand(key);
    }

    __m256i operator()(simd_avx512_xorshift128plus_key& key)
    {
    	return simd_xorshift128plus_rand(key);
    }
};
